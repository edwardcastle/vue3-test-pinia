...
<template>
  <div class="container mx-auto px-4 py-16">
    ...
    <!-- products -->
    <p class="text-center text-md inline-block">
      <span
        :class="tab === 0 ? `text-green-600` : ``"
        @click="setSelectedTabId(0)"
        >Products</span
      >
    </p>
    /
    <span
      :class="tab === 1 ? `text-green-600` : ``"
      @click="setSelectedTabId(1)"
    >
      Cart
    </span>
    <products-card />
